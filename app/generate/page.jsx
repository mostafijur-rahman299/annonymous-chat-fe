        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-900 via-teal-800 to-green-900 text-white p-6">
            ...
            >
                ...
                <p className="text-sm md:text-lg leading-relaxed max-w-3xl mx-auto mb-8 text-white/80 font-bold">
                    Create a unique room code and invite your friends to join
                    the chat. It's free and end to end encrypted. You can chat
                    anonymously, without revealing your personal details. Rest
                    assured, your privacy is our top priority, and all
                    conversations are securely encrypted.
                </p>
            </motion.div>
            <motion.div
